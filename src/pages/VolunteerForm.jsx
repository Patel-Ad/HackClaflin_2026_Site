...
export default function VolunteerForm() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      {/* Navigation */}
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-300" role="navigation" aria-label="Volunteer page navigation">
      ...
      <div className="relative w-full bg-white" style={{ height: 'calc(100vh - 73px)' }}>
        <iframe 
          ...
          aria-label="HackClaflin 2026 Volunteer Registration Form"
        />
      </div>
    </div>
  )
